...
// Warning USB3 endpoint 2 bulk with 8 or 16 burst can be problematic on some PC so default is set to 4
...
static struct cag_option options[] = {
	{ .identifier = 'v',
	  ...
	  .access_name = "verbose",
	  .value_name = "VALUE",
	  .description = "Verbose mode to have more details on output" },

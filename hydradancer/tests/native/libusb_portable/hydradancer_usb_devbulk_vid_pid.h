...
// Example "HydraUSB3_SN:0123456789ABCDEF"
#define USB_SERIAL_NUMBER_LEN_EXPECTED (29)

#define USB_SERIAL_HEADER_EXPECTED_LEN (13)
#define USB_SERIAL_HEADER_EXPECTED "HydraUSB3_SN:"
...
// Default USB Product ID
// Default PID 0x27D8
#define USB_PID_BYTE_MSB (0x27)
#define USB_PID_BYTE_LSB (0xD8)
#define USB_PID ((USB_PID_BYTE_MSB << 8) | USB_PID_BYTE_LSB)
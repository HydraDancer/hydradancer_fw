...
void endp0_tx_complete(TRANSACTION_STATUS status)
{
	LOG_IF_LEVEL(LOG_LEVEL_DEBUG, "endp0_tx_complete\r\n");
...
void endp1_tx_complete(TRANSACTION_STATUS status)
{
	LOG_IF_LEVEL(LOG_LEVEL_DEBUG, "endp1_tx_complete\r\n");
...
void endp2_tx_complete(TRANSACTION_STATUS status)
{
	LOG_IF_LEVEL(LOG_LEVEL_DEBUG, "endp2_tx_complete\r\n");
...
void endp3_tx_complete(TRANSACTION_STATUS status)
{
	LOG_IF_LEVEL(LOG_LEVEL_DEBUG, "endp3_tx_complete\r\n");
...
void endp4_tx_complete(TRANSACTION_STATUS status)
{
	LOG_IF_LEVEL(LOG_LEVEL_DEBUG, "endp4_tx_complete\r\n");
...
void endp5_tx_complete(TRANSACTION_STATUS status)
{
	LOG_IF_LEVEL(LOG_LEVEL_DEBUG, "endp5_tx_complete\r\n");
...
void endp6_tx_complete(TRANSACTION_STATUS status)
{
	LOG_IF_LEVEL(LOG_LEVEL_DEBUG, "endp6_tx_complete\r\n");
...
void endp7_tx_complete(TRANSACTION_STATUS status)
{
	LOG_IF_LEVEL(LOG_LEVEL_DEBUG, "endp7_tx_complete\r\n");
...
uint8_t endp0_passthrough_setup_callback(uint8_t* ptr, uint16_t size)
{
	LOG_IF_LEVEL(LOG_LEVEL_DEBUG, "endp0_passthrough_setup_callback %d %d %d %d %d %d \r\n", ptr[0], ptr[1], ptr[2], ptr[3], ptr[4], ptr[5]);
	hydradancer_status.ep_out_status |= (0x01 << 0);
	hspi_send(ptr, size, endpoint_mapping[0] & CUSTOM_REGISTER_ENDPOINT_MASK);
...
uint8_t endp0_rx_callback(uint8_t* const ptr, uint16_t size)
{
	...
	LOG_IF_LEVEL(LOG_LEVEL_DEBUG, "endp0_rx_callback %d %d %d %d %d %d \r\n", ptr[0], ptr[1], ptr[2], ptr[3], ptr[4], ptr[5]);
	hydradancer_status.ep_out_status |= (0x01 << 0);

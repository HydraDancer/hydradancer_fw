...
__attribute__((aligned(16))) uint8_t ep_status_buffer[2] __attribute__((section(".DMADATA")));
__attribute__((aligned(16))) static hydradancer_status_t hydradancer_status __attribute__((section(".DMADATA")));
__attribute__((aligned(16))) uint8_t placeholder __attribute__((section(".DMADATA")));

...
void init_endpoints(void)
{
	usb_device_0.endpoints.rx[0].buffer = ramx_pool_alloc_bytes(512);
	...
	usb_device_0.endpoints.tx[7].max_packet_size_with_burst = ENDP_1_15_MAX_PACKET_SIZE * DEF_ENDP_OUT_BURST_LEVEL;
}
